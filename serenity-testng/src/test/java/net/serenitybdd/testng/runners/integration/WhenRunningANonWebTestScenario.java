package net.serenitybdd.testng.runners.integration;

import com.google.inject.Guice;
import com.google.inject.Injector;

import net.serenitybdd.junit.runners.SerenityRunner;
import net.serenitybdd.testng.HomeTest;
import net.serenitybdd.testng.SerenityTestNGStarter;
import net.serenitybdd.testng.runners.AbstractTestStepRunnerTest;
...
public class WhenRunningANonWebTestScenario extends AbstractTestStepRunnerTest {
  ...
  /*  @Test
    ...
    public void json_test_results_are_written_to_the_output_directory()  throws Exception {
        ...
        File outputDirectory = temporaryFolder.newFolder();
        SerenityTestNGStarter.runTestClass(SamplePassingNonWebScenario.class);
